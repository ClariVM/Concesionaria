...
public class ConsultaAutomovil extends javax.swing.JFrame {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(btnModificar, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 101, Short.MAX_VALUE))
                .addContainerGap())
        );
        ...
        if(tablaAutos.getRowCount()>0){
            ...
            if(tablaAutos.getSelectedRow()!=-1){
               ...
               cargarTabla();
                ...
                mostrarMensaje("No seleccionaste ningún registro a eliminar", "Error", "Error al eliminar");
            }
        } else{
    ...
    private void cargarTabla() {
        ...
        //setear los datos traidos en la tabla
